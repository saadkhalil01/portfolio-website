...
export default function Home() {
  ...
  return (
    <div className="min-h-screen p-4 sm:p-8 relative overflow-hidden bg-white">
      ...
      <header className="text-left mb-16 relative z-20">
        ...
        <div className="space-y-4">
          <p className="text-2xl sm:text-3xl lg:text-4xl font-light text-black">
          ...
          <div className="flex items-center gap-4 mt-8 flex-wrap">
            ...
            >
              ...
              <span className="text-base font-medium hidden sm:inline">GitHub</span>
            </a>
          </div>
        </div>
      </header >
      ...
      {/* Experience Section */}
      {
        !selectedApp && (
          <section className="mb-20 relative z-10">
            ...
            {/* About Content */}
            <div className="max-w-4xl space-y-6 text-black text-lg leading-relaxed">
              <div className="bg-white border-2 border-black rounded-lg p-6 md:p-8">
                <p>
                  I'm a passionate <span className="font-semibold">React Native Developer</span> with over 2 years of professional experience building innovative mobile applications across diverse industries including <span className="font-medium">mental wellness, healthcare, education, and social engagement</span>.
                </p>
              </div>
              <div className="bg-white border-2 border-black rounded-lg p-6 md:p-8">
                <p>
      ...
      <footer className="text-center mt-20 mb-8 relative z-10">
        <p className="text-black text-base font-medium">
          © 2024 Muhammad Saad - React Native Developer
        </p>
